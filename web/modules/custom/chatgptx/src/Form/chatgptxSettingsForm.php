 ...
 */
class chatgptxSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'chatgptx_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['api_key'] = [
      ...
      '#default_value' => $this->config('chatgptx.settings')->get('api_key'),
    ...
    $form['api_org'] = [
      ...
      '#default_value' => $this->config('chatgptx.settings')->get('api_org'),
